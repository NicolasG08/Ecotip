...
const outputPath = path.join(__dirname, 'assets', 'images', 'splash-logo.png');
...
<svg width="480" height="480" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="240" cy="240" r="240" fill="url(#primaryGrad)" />
  
  <g transform="translate(120, 120) scale(0.46875)">
    ${leafPaths}
  </g>
</svg>
`;
...
async function generate() {
  await sharp(Buffer.from(svgString))
    .png()
    .toFile(outputPath);
  console.log("Successfully created splash-logo.png");
}
